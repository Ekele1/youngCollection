...
const NewCategory = () => {
  return (
    <div className='w-full dark:bg-[#1d283a] dark:text-gray-500'>
        <div className='w-full h-[70px] font-bold text-[20px] flex items-center'>
            <p>Add New Category</p>
        </div>
        <div className='w-full flex flex-col gap-3 bg-white dark:bg-[#1d283a] rounded-lg shadow-md p-3'>
            <div className='w-full h-[70px] flex flex-col lg:flex-row items-center justify-between'>
                <p>Category name</p>
                <input placeholder='Enter category name'
                className='w-[70%] h-[40px] dark:bg-[#1d283a] outline-none border-[1.5px] rounded-md border-gray-400 pl-2' type="text" />
            </div>

...
const WomenCollection = () => {
  ...
  return (
    <div className='w-full pl-5 pr-5 pb-20 mt-[110px]'>
        <div className='w-full h-[80px] text-[30px] font-bold flex items-center justify-center'>
            WOMEN COLLECTIONS
        </div>
        <div className='w-full flex justify-around gap-5 lg:gap-0 flex-wrap bg-[#f8f8f8] pb-10'>
            {
                all.map((e,i)=>(
                <div onClick={()=>nav("/detail")} className='w-[45%] lg:w-[18%] cursor-pointer hover:bg-gray-300 p-2 rounded' key={i}>
                    <div className='w-full relative'>
                        <img className='object-contain w-full rounded-[10px] h-full' src="./outfit.jpg" alt="" />
                    </div>
                    <div className='w-full'>
                        <p className='font-medium'>Quality women round neck</p>

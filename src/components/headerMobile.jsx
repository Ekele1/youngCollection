...
const MobileHeader = ({prop}) => {
  ...
  return (
    <div className='w-full p-4'>
        ...
        <div className='w-full h-[50px] pl-3 text-[18px] font-medium flex items-center'> MEN</div>
        <div className='w-full h-[50px] pl-3 text-[18px] font-medium flex items-center'> WOMEN</div>
        <div className='w-full h-[50px] pl-3 text-[18px] font-medium flex items-center'> COMPANY</div>
        <div className='w-full h-[50px] pl-3 text-[18px] font-medium flex items-center'> CONTACT</div>
